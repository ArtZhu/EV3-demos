...
import Behavior.Sept26.RightUndetected_2;
import CalcFix.Sept26.CalcFixer;
import CalcFix.Sept26.CalcFixer_1;
import PathFix.Sept26.*;
import assgt1.v1.MyRobot;

public class Assgt1_2 extends MyRobot{
	private static double turnConst1 = 0.895; //Somehow 1.04 is better; //carpetTurnConst; // 0.91 for floor
...
//				sideDistList.remove(sideSample[0]);
				...
				//
				new RightUndetected_2(turnConst1, 12.5).behave();
