...
public class RightUndetected_2 extends MyRobot implements Behavior{
	private Priority priority = new Priority(1);
	private double turnConst;
	private double stdDist;
	
	public RightUndetected_2(double _turnConst, double _stdDist){
	...
	public void behave() {
//		Sound.beep();
		_position.update(robotTrack / 2.0 + stdDist + wheelDiameter/2);
		_position.turnRight();
