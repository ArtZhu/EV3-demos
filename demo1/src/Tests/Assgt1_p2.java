...
public class Assgt1_p2 extends MyRobot{
	private static double turnConst = 1.05; //Somehow 1.04 is better; //carpetTurnConst;
...
//	private static List<Behavior> behaviors = new ArrayList<Behavior>(Arrays.asList(new FrontEncounter(turnConst), new RightUndetected(turnConst)));
	...
	private static List<Double> sides = new ArrayList<Double>();
...
//				sideDistList.remove(sideSample[0]);
				...
				//
				new RightUndetected(turnConst, 10).behave();
