...
public class Assgt1BehaviorTest extends MyRobot{
	private static double turnConst = 0.910; //Somehow 1.04 is better; //carpetTurnConst;
...
//				sideDistList.remove(sideSample[0]);
				...
				//
				new RightUndetected(turnConst, 5.0).behave();
