...
//	protected static globalData touchedData = new globalData();
	...
	static final double turnConst = 0.895;
...
/*
		//GetBack!
		lm.rotate((int) (-1 * robotLength/ wheelCircumference * 360 / 2), true);
		rm.rotate((int) (-1 * robotLength/ wheelCircumference * 360 / 2));
		lm.waitComplete();
		rm.waitComplete();
*/
		lm.stop(true);
